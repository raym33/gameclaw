...
function buildCreativeDirectionPrompt(notes: string, images: UploadedImage[]): string {
  ...
  return [
    ...
    'If the request is educational, classroom-friendly, training-oriented, or explicitly about gamification, bias toward low-friction mastery loops, readable content surfaces, and light pressure instead of combat-first design.',
    'If the request is about a garden, traffic rules, cooking, or another learn-by-doing simulation with a central character and task stations, bias toward a task-chain loop with clear world props and short procedures.',
